...
- (void)viewDidLoad {
    ...
    self.loadMoreActivityView.center = self.view.center;
...
//    else {
        ...
        MCOIMAPFetchContentOperation * op = [_session fetchMessageByUIDOperationWithFolder:_folder uid:[self.mailInfo.zxh_mail_mailinfo_remoteid intValue]];
        [_ops addObject:op];
